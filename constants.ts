...
export const PRODUCTS: Product[] = [
  {
    ...
    reviews: 120,
    inStock: true,
    description: 'এই প্রিমিয়াম ওয়্যারলেস হেডফোনের সাথে হাই-ফিডেলিটি অডিওর অভিজ্ঞতা নিন। এতে রয়েছে অ্যাক্টিভ নয়েজ ক্যান্সেলেশন, ৩০ ঘণ্টার ব্যাটারি লাইফ এবং দীর্ঘক্ষণ ব্যবহারের জন্য আরামদায়ক ইয়ার কুশন। মিউজিক লাভার এবং গেমারদের জন্য একটি আদর্শ পছন্দ।',
    features: ['অ্যাক্টিভ নয়েজ ক্যান্সেলেশন', '৩০ ঘণ্টা ব্যাটারি লাইফ', 'ব্লুটুথ ৫.০ কানেক্টিভিটি', 'সুপার বেস সাউন্ড'],
  ...
  },
  {
    ...
    reviews: 85,
    inStock: true,
    description: '১০০% অর্গানিক কটন দিয়ে তৈরি, এই পোলো শার্টটি আপনাকে দেবে আরামদায়ক অনুভূতি। ক্যাজুয়াল আউটিং বা সেমি-ফর্মাল ইভেন্টের জন্য পারফেক্ট। এর কালার গ্যারান্টি এবং প্রিমিয়াম ফিনিশিং আপনাকে দেবে স্মার্ট লুক।',
    features: ['১০০% অর্গানিক কটন', 'ব্রিদেবল ফেব্রিক', 'স্মার্ট ফিট', 'লং লাস্টিং কালার'],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
  ...
  },
  {
    ...
    validity_days: 30,
    description: 'SEMRush-এর প্রিমিয়াম এসইও টুলকিটে ফুল অ্যাক্সেস পান। কম্পিটিটর অ্যানালিসিস, কিওয়ার্ড ট্র্যাকিং, সাইট অডিট এবং কন্টেন্ট মার্কেটিং স্ট্র্যাটেজি তৈরি করুন খুব সহজেই। ডিজিটাল মার্কেটারদের জন্য এটি একটি অপরিহার্য টুল।',
    features: ['কিওয়ার্ড অ্যানালিটিক্স', 'সাইট অডিট', 'কম্পিটিটর ট্র্যাকিং', 'ব্যাকলিংক অ্যানালিসিস', 'কনটেন্ট অপ্টিমাইজেশন']
  }
];
